    ...
    return (
        <>
            ...
            <div className='md:flex'>
                ...
                <div className='flex-grow text-center h-24 '>
                    <button className='border border-blue-500 py-4  px-12 rounded-xl text-gray-500 w-1/2 font-semibold text-4xl tracking-widest bg-gray-100 hover:bg-gray-300'>Button</button>
                </div>
            </div>
        </>
    )
