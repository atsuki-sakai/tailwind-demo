    ...
    return (
        <>
            ...
            <div className='md:flex'>
                ...
                <div className='flex-grow text-center h-24'>
                    <button className='bg-green-300 hover: bg-green-600  border border-blue-500 py-4 px-12 rounded-xl text-gray-500 w-1/2 font-semibold text-4xl tracking-widest'>Button</button>
                </div>
            </div>
        </>
    )
