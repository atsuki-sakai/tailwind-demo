...
const Transform = () => {
    return (
        <div className='m-12'>
            ...
            translate
            <div className='origin-left transform duration-500 hover:translate-x-8 w-48 h-48 bg-red-500'></div>
            skew
            <div className='origin-left transform duration-500 hover:skew-y-6 w-48 h-48 bg-red-500'></div>
