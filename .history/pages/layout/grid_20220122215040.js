...
const Grid = () => {
    return (
        <>
            {/* grid-colの高さを指定した要素のある行全てに適用される */}
            <div className="grid grid-cols-4 gap-4 m-12">
                ...
                <div className="border col-span-2">
                    <p className="bg-indigo-200 text-center py-9">10</p>
                </div>
            </div>
            {/* grid-rowsはgrid-flow-****が必要 */}
            {/* grid-rowのの子要素どれか一つでも高さを指定すると全てに適用される */}
            <div className="grid grid-rows-3 grid-flow-col mt-12 mb-12">
                <div className="border">
                    <p className="text-center py-9">1</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">2</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">3</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">4</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">5</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">6</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">7</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">8</p>
                </div>
                <div className="border">
                    <p className="text-center py-9">9</p>
                </div>
            </div>
        </>
