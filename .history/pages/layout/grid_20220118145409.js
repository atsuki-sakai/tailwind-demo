...
const Grid = () => {
    return (
        <div className="grid grid-cols-4 gap-4 m-12">
            ...
            <div className="border col-span-2 bg-cyan-600 h-24">
                <p className="bg-purple-200 text-center py-9">2</p>
            </div>
            <div className="border">
                <p className="bg-orange-200 text-center py-9">3</p>
            </div>
            <div className="border col-span-2 bg-cyan-400 h-48">
            ...
            <div className="border">
                <p className="bg-lighgray-200 text-center py-9">8</p>
            </div>
            <div className="border col-span-2 bg-indigo-200 h-72">9</div>
        </div>
    )
}
