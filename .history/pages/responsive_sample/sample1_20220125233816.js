...
const Sample1 = () => {
    return (
        <>
            ...
            <div className='md:flex'>
                <div className='text-center border border-blue-400 py-4 flex-grow md:w-3/12'></div>
                <div className='text-center border border-blue-400 py-4 flex-grow md:6/12'></div>
                <div className='text-center border border-blue-400 py-4 flex-grow md:3/12'></div>
            </div>
        </>
    );
}
