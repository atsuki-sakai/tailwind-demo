    ...
    return (
        <div>
            ...
            <div className="mt-12 flex justify-around">
                ...
                <div className="w-24 bg-yellow-400 rounded-full text-center py-9 text-white ring-4 ring-yellow-800 font-bold ring-offset-4 ring-offset-white-100">Ring</div>
            </div>
        </div>
